...
parser.add_argument('--n_colors', type=int, default=480, help='number of spectral channels to use')
parser.add_argument('--dir_data', type=str, default='./hdata/data/', help='dataset directory')
...
# storage setting
parser.add_argument('--save_dir', type=str, default='second_model', help='results directory')
...
# test setting
parser.add_argument("--model_path", default="hsr/model/200_G.pth", type=str, help="path to checkpoint")
